...
<template>
  ...
  <PageContainer>
    ...
    <p>These terms and conditions apply to the Repflux app (hereby referred to as "Application") that
      was created by Tóth Patrik e.v. (hereby referred to as "Service Provider") as an Open Source service.</p><br>
    ...
    <p>The Service Provider may wish to update the application at some point. The application is currently available as
      ...
      these terms will end; (b) you must cease using the application, and (if necessary) delete it from your device.</p>
    ...
    <p>The Service Provider may periodically update their Terms and Conditions. Therefore, you are advised to review
      this page regularly for any changes. The Service Provider will notify you of any changes by posting the new Terms
      and Conditions on this page.</p><br>
    <p>These terms and conditions are effective as of 2025-10-17</p><br><strong>Contact Us</strong>
    <p>If you have any questions or suggestions about the Terms and Conditions, please do not hesitate to contact the
      Service Provider at info@repflux.app.</p>
    <hr>
